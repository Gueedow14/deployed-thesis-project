...
def add_campaign_argument(parser):
...
def add_campaign_data_argument(parser):
...
def add_value_argument(parser):
    parser.add_argument("--val", type=str, required=True)

def add_attribute_argument(parser):
    parser.add_argument("--attr", type=str, required=True)

def add_relationship_argument(parser):
    parser.add_argument("--rel", type=str, required=True)

def add_attr_edge_argument(parser):
    parser.add_argument("--owner", type=str, required=True)
    parser.add_argument("--attr", type=str, required=True)
    parser.add_argument("--value", type=str, required=True)

def add_rel_edge_argument(parser):
