...
def main(args):
    ...
    if args["campaign"] is None:
        ...
        clusters_path = putils.get_campaign_anony_clusters_path(data_name, sample, args["campaign"], info_loss_name, handler_name, calgo_name, enforcer_name, args)
        clusters = Clusters.from_file(clusters_path)
        ...
        # save anonymized graph
        anony_graph_path = putils.get_campaign_anony_graph_path(data_name, sample, args["campaign"], info_loss_name, handler_name, calgo_name, enforcer_name, args)

        anony_graph.to_edge_files(anony_graph_path)
        logger.info("saved anonymized graph to {}".format(anony_graph_path))
